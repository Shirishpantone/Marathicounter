              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <ul className="text-gray-600 space-y-1 text-sm">
                    ...
                    <li>• <span className="font-mono">10000</span> → <span className="font-bold">दहा हजार</span></li>
                    ...
                    <li>• <span className="font-mono">1000000000</span> → <span className="font-bold">एक अर्ब (शंभर कोटी)</span></li>
                  </ul>
                </div>
              </div>
            </div>
