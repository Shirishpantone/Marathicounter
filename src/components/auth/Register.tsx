...
export const Register: React.FC<RegisterProps> = ({ onClose, onSwitchToLogin }) => {
  ...
  const getPasswordStrength = (password: string) => {
    ...
    if (password.length < 10) return { strength: 'medium', color: 'bg-warning' };
    ...
    >
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-charcoal-light">Join MarathiCounter today</p>
        </div>
            ...
            {password && (
              <div className="mt-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-charcoal-light capitalize">{passwordStrength.strength}</span>
                </div>
              </div>
            )}
            {errors.password && (
